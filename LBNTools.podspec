#
#  Be sure to run `pod spec lint LBNTools.podspec' to ensure this is a
...
# Or just: s.author    = "Luciano Bastos Nunes"
# s.authors            = { "Luciano Bastos Nunes" => "luciano.nunes@tap4mobile.com" }
# s.social_media_url   = "http://twitter.com/Luciano Bastos Nunes"
...
s.source       = { :git => "https://github.com/sciasxp/LBNTools.git", :tag => "#{s.version}" }
